...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["csv-entry-csv-entry-module-ngfactory"], {
  ...
  /***/
  function distLibsUiCsvEntryFesm2015TerminusUiCsvEntryJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TsCSVEntryComponent", function () {
      return TsCSVEntryComponent;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "TsCSVEntryModule", function () {
      return TsCSVEntryModule;
    });
    /* harmony import */
    ...
    var _terminus_ui_tooltip__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! @terminus/ui-tooltip */
    ...
    var _terminus_ngx_tools_coercion__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! @terminus/ngx-tools/coercion */
    "../../node_modules/@terminus/ngx-tools/fesm2015/terminus-ngx-tools-coercion.js");
    /* harmony import */


    var _terminus_ngx_tools_utilities__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! @terminus/ngx-tools/utilities */
    "../../node_modules/@terminus/ngx-tools/fesm2015/terminus-ngx-tools-utilities.js");
    /* harmony import */


    var _terminus_ui_spacing__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! @terminus/ui-spacing */
    "../../dist/libs/ui/spacing/fesm2015/terminus-ui-spacing.js");
    /* harmony import */


    var _terminus_ui_utilities__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    ...
    var DEFAULT_MAX_ROWS = 2000;
    var DEFAULT_VALIDATION_MESSAGES_MAX = 6;
    /**
    ...
    var TsCSVEntryComponent = TsCSVEntryComponent_1 = /*#__PURE__*/function () {
      function TsCSVEntryComponent(formBuilder, changeDetectorRef, documentService) {
        _classCallCheck(this, TsCSVEntryComponent);
        ...
        this.uid = "ts-csv-entry-".concat(nextUniqueId++);
        /**
      ...
      _createClass(TsCSVEntryComponent, [{
        key: "ngOnInit",
        ...
        value: function ngOnInit() {
          ...
          this.recordsForm.valueChanges.pipe( // Let the form values 'settle' before we emit anything
          Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["debounceTime"])(1), Object(_terminus_ngx_tools_utilities__WEBPACK_IMPORTED_MODULE_12__["untilComponentDestroyed"])(this)).subscribe(function (v) {
            var blob = _this.generateBlob(v);

            _this.blobGenerated.emit(blob);
          });
        }
        /**
        ...
        value: function addRows() {
          var rowCount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
          var columnCount = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.columnCount;
          var content = arguments.length > 2 ? arguments[2] : undefined;
          var index = arguments.length > 3 ? arguments[3] : undefined;

          if (this.rows.length + rowCount > this.maxRows) {
            // eslint-disable-next-line @typescript-eslint/no-magic-numbers
            var rowsThatDontFit = (rowCount === 1 ? 2 : rowCount) - (this.rows.length + rowCount - this.maxRows);
            this.tooManyRowsMessage = "Adding ".concat(rowsThatDontFit, " row").concat(rowsThatDontFit > 1 ? 's' : '', " would exceed the maximum rows allowed (").concat(this.maxRows, ").");
            return;
          }
          ...
          for (var i = 0; i < rowCount; i += 1) {
            var indexToInjectAt = (index === undefined ? this.rowCount : index) + i;
            var c = content ? content[i] : null;
            var createdRow = this.createRow(this.rows.length, c);
        ...
        key: "updateAllRowIds",
        value: function updateAllRowIds() {
          for (var i = 0; i < this.rows.length; i += 1) {
            var row = this.rows.controls[i]; // istanbul ignore else
        ...
        key: "onPaste",
        value: function onPaste(event, hasHeader) {
          var _a;

          var eventContent = (_a = event.clipboardData) === null || _a === void 0 ? void 0 : _a.getData('Text');
          ...
          var isSingleCell = eventContent.indexOf('\n') < 0 && eventContent.indexOf('\t') < 0;
          ...
          var pastedRowId = parseInt(event.target.id.split('X')[0].split('_')[2], 10);
          var content = TsCSVEntryComponent_1.splitContent(eventContent, hasHeader);
          var neededRows = content.rows.length; // If the paste was into a header cell, verify that header cell content doesn't already exist
          ...
          if (hasHeader) {
            ...
            var pastedColumnCount = content.rows[0].length; // If more columns were pasted than currently exist, increase the column count

            if (pastedColumnCount > this.columnCount) {
              var numberOfMissingColumns = pastedColumnCount - this.columnCount;
        ...
        key: "getHeaderCellName",
        value: function getHeaderCellName(index) {
        ...
        value: function onScroll(event) {
          ...
          var dir = event.deltaX < 0 ? 'right' : 'left'; // NOTE: TypeScript doesn't believe `form` exists on `EventTarget`
          ...
          var borderSize = 2;
          var scrollRight = targetEl.form.scrollWidth - (parseInt(targetEl.form.offsetWidth, 10) + borderSize) - targetEl.form.scrollLeft;
          var scrollLeft = targetEl.form.scrollLeft;
          var stopRightScroll = dir === 'right' && scrollLeft < 1;
          var stopLeftScroll = dir === 'left' && scrollRight < 1; // If scrolling horizontally and at either edge, stop the scroll event
        ...
        key: "selectCellInNextRow",
        value: function selectCellInNextRow(currentCellId, up) {
          if (!currentCellId) {
            return;
          }

          var _currentCellId$split = currentCellId.split('X'),
              _currentCellId$split2 = _slicedToArray(_currentCellId$split, 2),
              rowId = _currentCellId$split2[0],
              columnId = _currentCellId$split2[1];

          var row = rowId.split('_')[2];
          var column = columnId.split('_')[1];
          var newId = "".concat(this.uid, "_r_").concat(parseInt(row, 10) + (up ? -1 : 1), "Xc_").concat(column);
          var input = this.documentService.document.querySelector("#".concat(newId));
        ...
        key: "selectAdjacentCell",
        value: function selectAdjacentCell(event, currentCellId, previous) {
          ...
          var _currentCellId$split3 = currentCellId.split('X'),
              _currentCellId$split4 = _slicedToArray(_currentCellId$split3, 2),
              rowId = _currentCellId$split4[0],
              columnId = _currentCellId$split4[1];

          var row = parseInt(rowId.split('_')[2], 10);
          var column = parseInt(columnId.split('_')[1], 10);
          var isFirstColumn = column === 0;
          var isLastColumn = column === this.columnCount - 1;
          var newColumnNumber;
          var newRowNumber = row; // If first column, move to last column of previous row
          ...
          var newId = "".concat(this.uid, "_r_").concat(newRowNumber, "Xc_").concat(newColumnNumber);
          var input = this.documentService.document.querySelector("#".concat(newId)); // istanbul ignore else
        ...
        key: "createId",
        value: function createId(recordIndex, cellIndex) {
          return "".concat(this.uid, "_r_").concat(recordIndex, "Xc_").concat(cellIndex);
        }
        /**
        ...
        value: function collectErrors() {
          var group = this.recordsForm.get('records'); // istanbul ignore else

          if (group) {
            var errors = this.getFormErrors(group); // istanbul ignore else

            if (errors) {
              return Object.keys(errors).map(function (key) {
                return _defineProperty({
                  control: key
                }, key, errors[key].filter(function (el, i, arr) {
        ...
        key: "getFormErrors",
        value: function getFormErrors(form) {
          var result = {};
        ...
        key: "getAllErrors",
        value: function getAllErrors(form, result) {
          var keys = Object.keys(form.controls); // eslint-disable-next-line @typescript-eslint/prefer-for-of

          for (var i = 0; i < keys.length; i += 1) {
            var ctrl = form.get(keys[i]); // istanbul ignore else

            if (ctrl) {
              var errors = ctrl instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"] || ctrl instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormArray"] ? this.getAllErrors(ctrl, result) : ctrl.errors; // istanbul ignore else

              if (errors) {
                // Get the record ID from the grandparent control
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                var grandparentControls = ctrl.parent.parent.controls;
                var rowId = grandparentControls.recordId ? grandparentControls.recordId.value
                /* istanbul ignore next - Unreachable */
                : undefined;
                var errorKeys = Object.keys(errors); // eslint-disable-next-line @typescript-eslint/prefer-for-of

                for (var j = 0; j < errorKeys.length; j += 1) {
                  var errorKey = errorKeys[j]; // eslint-disable-next-line @typescript-eslint/no-explicit-any

                  var error = errors[errorKeys[j]]; // Angular built in required validator only returns a boolean
        ...
        key: "clearHeaderCells",
        value: function clearHeaderCells() {
        ...
        key: "addHeaders",
        value: function addHeaders(headerCount, content) {
          for (var i = 0; i < headerCount; i += 1) {
            var value = content && content[i] ? content[i] : null;
            var ctrl = value ? new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](value) : new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]();
        ...
        key: "createRow",
        value: function createRow(id, content) {
        ...
        key: "createColumns",
        value: function createColumns(count, content) {
          var columns = [];

          for (var i = 0; i < count; i += 1) {
            var value = content && content[i] ? content[i] : null; // Strip any control characters

            if (value) {
              value = Object(_terminus_ui_utilities__WEBPACK_IMPORTED_MODULE_14__["stripControlCharacters"])(value);
            }

            var validator = this.columnValidators ? this.columnValidators[i]
            /* istanbul ignore next - Unreachable */
            : null;
        ...
        key: "generateBlob",
        value: function generateBlob(content) {
          var prefix = 'data:text/csv;charset=utf-8,';
          var headers = "".concat(content.headers.join('\t'), "\r\n"); // Encapsulate content with quotes and escape any existing quotes

          var rows = "".concat(content.records.map(function (v) {
            return v.columns.map(function (column) {
              return column ? "\"".concat(column.replace(/"/g, '""'), "\"") : '';
            }).join('\t');
          }).join('\r\n'), "\r\n");
          var joined = prefix + headers + rows; // istanbul ignore else
        ...
        get: function get() {
          ...
          var _iterator = _createForOfIteratorHelper(this.allErrors),
              _step;

          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              var errorObj = _step.value;
              var name = errorObj.control;

              var _iterator2 = _createForOfIteratorHelper(errorObj[name]),
                  _step2;

              try {
                for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                  var error = _step2.value;
                  var message = ''; // The ID is zero-based

                  message += "<b>Row ".concat(parseInt(error.rowId, 10) + 1, ":</b> "); // istanbul ignore else

                  if (name === 'url') {
                    var maxItemLength = 20;
                    var errorItem = error.actual.length > maxItemLength ? "".concat(error.actual.slice(0, maxItemLength), "...") : error.actual;
                    message += "\"".concat(errorItem, "\" is not a valid URL.");
                  } // istanbul ignore else
          ...
          if (messages.length > DEFAULT_VALIDATION_MESSAGES_MAX) {
            var count = messages.length - DEFAULT_VALIDATION_MESSAGES_MAX;
            messages.length = DEFAULT_VALIDATION_MESSAGES_MAX;
            messages.push("and ".concat(count, " more errors..."));
          }

          return messages.length > 0 ? messages : undefined;
        }
      }], [{
        key: "addColumnsToRows",
        value: function addColumnsToRows(rows, headerCells, columnsToAdd) {
          // Add columns to body rows
          for (var i = 0; i < rows.length; i += 1) {
            var row = rows.controls[i]; // istanbul ignore else

            if (row) {
              var columns = row.controls.columns;

              for (var j = 0; j < columnsToAdd; j += 1) {
          ...
          for (var k = 0; k < columnsToAdd; k += 1) {
        ...
        key: "splitContent",
        value: function splitContent(content, hasHeaders) {
          var result = {
            headers: undefined,
            rows: undefined
          };
          ...
          if (hasHeaders) {
            ...
            result.rows = rows.slice(1, rows.length).map(function (r) {
              return r.split('\t');
            });
          } else {
            result.rows = rows.slice(0, rows.length).map(function (r) {
              return r.split('\t');
            });
          }
    ...
    TsCSVEntryComponent.ctorParameters = function () {
      return [{
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Number), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Number])], TsCSVEntryComponent.prototype, "columnCount", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Array), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Array])], TsCSVEntryComponent.prototype, "columnHeaders", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object])], TsCSVEntryComponent.prototype, "columnValidators", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", String)], TsCSVEntryComponent.prototype, "footerDirection", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], TsCSVEntryComponent.prototype, "fullWidth", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", String), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [String])], TsCSVEntryComponent.prototype, "id", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Number), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Number])], TsCSVEntryComponent.prototype, "maxRows", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", String)], TsCSVEntryComponent.prototype, "outputFormat", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Number), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Number])], TsCSVEntryComponent.prototype, "rowCount", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"])], TsCSVEntryComponent.prototype, "blobGenerated", void 0);
    TsCSVEntryComponent = TsCSVEntryComponent_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], _angular_core__WEBPACK_IMPORTED_MODULE_2__["ChangeDetectorRef"], _terminus_ngx_tools_browser__WEBPACK_IMPORTED_MODULE_10__["TsDocumentService"]])], TsCSVEntryComponent);

    var TsCSVEntryModule = function TsCSVEntryModule() {
      _classCallCheck(this, TsCSVEntryModule);
    };

    TsCSVEntryModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _terminus_ui_button__WEBPACK_IMPORTED_MODULE_5__["TsButtonModule"], _terminus_ui_icon_button__WEBPACK_IMPORTED_MODULE_7__["TsIconButtonModule"], _terminus_ui_icon__WEBPACK_IMPORTED_MODULE_6__["TsIconModule"], _terminus_ui_tooltip__WEBPACK_IMPORTED_MODULE_8__["TsTooltipModule"]],
  ...
  /***/
  function distLibsUiCsvEntryTerminusUiCsvEntryNgfactoryJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TsCSVEntryModuleNgFactory", function () {
      return TsCSVEntryModuleNgFactory;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "RenderType_TsCSVEntryComponent", function () {
      return RenderType_TsCSVEntryComponent;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "View_TsCSVEntryComponent_0", function () {
      return View_TsCSVEntryComponent_0;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "View_TsCSVEntryComponent_Host_0", function () {
      return View_TsCSVEntryComponent_Host_0;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "TsCSVEntryComponentNgFactory", function () {
      return TsCSVEntryComponentNgFactory;
    });
    /* harmony import */
    ...
    var _terminus_ui_csv_entry__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var _icon_button_terminus_ui_icon_button_ngfactory__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
    /*! ../icon-button/terminus-ui-icon-button.ngfactory */
    "../../dist/libs/ui/icon-button/terminus-ui-icon-button.ngfactory.js");
    /* harmony import */


    var _button_terminus_ui_button_ngfactory__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
    ...
    var TsCSVEntryModuleNgFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵcmf"](_terminus_ui_csv_entry__WEBPACK_IMPORTED_MODULE_1__["TsCSVEntryModule"], [], function (_l) {
    ...
    var RenderType_TsCSVEntryComponent = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵcrt"]({
      encapsulation: 2,
      styles: styles_TsCSVEntryComponent,
      data: {}
    });

    function View_TsCSVEntryComponent_1(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 6, "div", [["class", "c-csv-entry__column-id"], ["fxFlex", "0 0 auto"], ["fxLayout", "row"], ["fxLayoutAlign", "center center"]], [[2, "c-csv-entry__column-id--invalid", null], [1, "id", 0]], null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](1, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultLayoutDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["LayoutStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        ...
        var currVal_0 = _v.context.$implicit.invalid;
        var currVal_1 = "csv-row-id-" + (_v.context.index + 1);

        _ck(_v, 0, 0, currVal_0, currVal_1);

        var currVal_6 = (_v.context.$implicit.controls == null ? null : _v.context.$implicit.controls.recordId == null ? null : _v.context.$implicit.controls.recordId.value) - 0 + 1;
    ...
    function View_TsCSVEntryComponent_2(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 5, "input", [["class", "c-csv-entry__input c-csv-entry__input--header qa-csv-entry-header-cell"], ["type", "text"]], [[8, "title", 0], [8, "readOnly", 0], [1, "id", 0], [2, "ng-untouched", null], [2, "ng-touched", null], [2, "ng-pristine", null], [2, "ng-dirty", null], [2, "ng-valid", null], [2, "ng-invalid", null], [2, "ng-pending", null]], [[null, "paste"], [null, "keydown.enter"], [null, "keydown.tab"], [null, "keydown.shift.tab"], [null, "input"], [null, "blur"], [null, "compositionstart"], [null, "compositionend"]], function (_v, en, $event) {
        var ad = true;
        ...
        return ad;
      }, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](1, 16384, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["DefaultValueAccessor"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], [2, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["COMPOSITION_BUFFER_MODE"]]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵprd"](1024, null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["NG_VALUE_ACCESSOR"], function (p0_0) {
        return [p0_0];
      }, [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["DefaultValueAccessor"]]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](3, 671744, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControlName"], [[3, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ControlContainer"]], [8, null], [8, null], [6, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["NG_VALUE_ACCESSOR"]], [2, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ɵangular_packages_forms_forms_p"]]], {
        name: [0, "name"]
      }, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵprd"](2048, null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["NgControl"], null, [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControlName"]]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](5, 16384, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["NgControlStatus"], [[4, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["NgControl"]]], null, null)], function (_ck, _v) {
        ...
        var currVal_0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵinlineInterpolate"](1, "Header, Column: ", _co.getHeaderCellName(_v.context.index) || _v.context.index + 1, "");

        var currVal_1 = _co.columnHeaders && _co.columnHeaders[_v.context.index];

        var currVal_2 = _co.createId(0 - 1, _v.context.index);

        var currVal_3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 5).ngClassUntouched;

        var currVal_4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 5).ngClassTouched;

        var currVal_5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 5).ngClassPristine;

        var currVal_6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 5).ngClassDirty;

        var currVal_7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 5).ngClassValid;

        var currVal_8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 5).ngClassInvalid;

        var currVal_9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 5).ngClassPending;

        _ck(_v, 0, 0, currVal_0, currVal_1, currVal_2, currVal_3, currVal_4, currVal_5, currVal_6, currVal_7, currVal_8, currVal_9);
      });
    }

    function View_TsCSVEntryComponent_4(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 5, "input", [["class", "c-csv-entry__input qa-csv-entry-cell"], ["type", "text"]], [[2, "c-csv-entry__input--invalid", null], [8, "title", 0], [1, "id", 0], [2, "ng-untouched", null], [2, "ng-touched", null], [2, "ng-pristine", null], [2, "ng-dirty", null], [2, "ng-valid", null], [2, "ng-invalid", null], [2, "ng-pending", null]], [[null, "paste"], [null, "keydown.enter"], [null, "keydown.shift.enter"], [null, "keyup"], [null, "keydown.tab"], [null, "keydown.shift.tab"], [null, "input"], [null, "blur"], [null, "compositionstart"], [null, "compositionend"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
        ...
        var currVal_1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵinlineInterpolate"](2, "Row: ", (_v.parent.context.$implicit.controls == null ? null : _v.parent.context.$implicit.controls.recordId == null ? null : _v.parent.context.$implicit.controls.recordId.value) + 1, ", Column: ", _co.getHeaderCellName(_v.context.index) || _v.context.index + 1, "");

        var currVal_2 = _co.createId(_v.parent.context.index, _v.context.index);
    ...
    function View_TsCSVEntryComponent_3(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 9, "div", [["class", "c-csv-entry__row qa-csv-entry-row"]], [[2, "ng-untouched", null], [2, "ng-touched", null], [2, "ng-pristine", null], [2, "ng-dirty", null], [2, "ng-valid", null], [2, "ng-invalid", null], [2, "ng-pending", null]], null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](1, 212992, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormGroupName"], [[3, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ControlContainer"]], [8, null], [8, null]], {
        ...
        var currVal_15 = "columns";

        _ck(_v, 5, 0, currVal_15);

        var tmp_16_0 = null;
        var currVal_16 = (tmp_16_0 = _co.getColumns(_v.context.$implicit)) == null ? null : tmp_16_0.controls;

        _ck(_v, 9, 0, currVal_16);
      }, function (_ck, _v) {
        var currVal_0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 3).ngClassUntouched;

        var currVal_1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 3).ngClassTouched;

        var currVal_2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 3).ngClassPristine;

        var currVal_3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 3).ngClassDirty;

        var currVal_4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 3).ngClassValid;

        var currVal_5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 3).ngClassInvalid;

        var currVal_6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 3).ngClassPending;

        _ck(_v, 0, 0, currVal_0, currVal_1, currVal_2, currVal_3, currVal_4, currVal_5, currVal_6);

        var currVal_8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 7).ngClassUntouched;

        var currVal_9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 7).ngClassTouched;

        var currVal_10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 7).ngClassPristine;

        var currVal_11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 7).ngClassDirty;

        var currVal_12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 7).ngClassValid;

        var currVal_13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 7).ngClassInvalid;

        var currVal_14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 7).ngClassPending;

        _ck(_v, 4, 0, currVal_8, currVal_9, currVal_10, currVal_11, currVal_12, currVal_13, currVal_14);
      });
    }

    function View_TsCSVEntryComponent_5(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 3, "ts-icon-button", [["class", "c-csv-entry__delete qa-csv-entry-delete ts-icon-button"], ["fxFlex", "noshrink"]], [[1, "id", 0], [1, "title", 0]], [[null, "click"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
        ...
        return ad;
      }, _icon_button_terminus_ui_icon_button_ngfactory__WEBPACK_IMPORTED_MODULE_27__["View_TsIconButtonComponent_0"], _icon_button_terminus_ui_icon_button_ngfactory__WEBPACK_IMPORTED_MODULE_27__["RenderType_TsIconButtonComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](1, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultFlexDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["LAYOUT_CONFIG"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["FlexStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxFlex: [0, "fxFlex"]
      }, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](2, 49152, null, 0, _terminus_ui_icon_button__WEBPACK_IMPORTED_MODULE_23__["TsIconButtonComponent"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"]], null, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](-1, 0, ["delete_forever"]))], function (_ck, _v) {
        var currVal_2 = "noshrink";

        _ck(_v, 1, 0, currVal_2);
      }, function (_ck, _v) {
        var currVal_0 = "csv-delete-" + (_v.context.index + 1);
        var currVal_1 = "Delete row " + (_v.context.index + 1);

        _ck(_v, 0, 0, currVal_0, currVal_1);
      });
    }

    function View_TsCSVEntryComponent_6(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 0, "div", [["class", "c-csv-entry__message qa-csv-entry-message"]], [[8, "innerHTML", 1]], null, null, null, null))], null, function (_ck, _v) {
    ...
    function View_TsCSVEntryComponent_7(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 1, "div", [["class", "c-csv-entry__message qa-csv-entry-message"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](1, null, ["", ""]))], null, function (_ck, _v) {
        var _co = _v.component;
        var currVal_0 = _co.tooManyRowsMessage;

        _ck(_v, 1, 0, currVal_0);
      });
    }

    function View_TsCSVEntryComponent_0(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](2, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 64, "div", [["class", "c-csv-entry qa-csv-entry"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](1, 0, null, null, 3, "div", [["class", "c-csv-entry__info qa-csv-entry-info"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](2, null, [" ", " row", " "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](3, 0, null, null, 0, "br", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](4, null, [" ", " column", " "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](5, 0, null, null, 32, "div", [["class", "c-csv-entry__scroll"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](6, 0, null, null, 31, "div", [["fxLayout", "row"]], null, null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](7, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultLayoutDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["LayoutStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxLayout: [0, "fxLayout"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](8, 0, null, null, 5, "div", [["fxLayout", "column"]], null, null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](9, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultLayoutDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["LayoutStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxLayout: [0, "fxLayout"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](10, 0, null, null, 1, "div", [["fxFlex", "0 0 auto"]], [[4, "height", null]], null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](11, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultFlexDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["LAYOUT_CONFIG"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["FlexStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxFlex: [0, "fxFlex"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵand"](16777216, null, null, 1, null, View_TsCSVEntryComponent_1)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](13, 278528, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["TemplateRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["IterableDiffers"]], {
        ngForOf: [0, "ngForOf"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](14, 0, [["form", 1]], null, 17, "form", [["class", "c-csv-entry__form"], ["fxFlex", ""], ["novalidate", ""]], [[2, "ng-untouched", null], [2, "ng-touched", null], [2, "ng-pristine", null], [2, "ng-dirty", null], [2, "ng-valid", null], [2, "ng-invalid", null], [2, "ng-pending", null]], [[null, "mousewheel"], [null, "submit"], [null, "reset"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
        ...
        return ad;
      }, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](15, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultFlexDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["LAYOUT_CONFIG"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["FlexStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxFlex: [0, "fxFlex"]
      }, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](16, 16384, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ɵangular_packages_forms_forms_y"], [], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](17, 540672, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormGroupDirective"], [[8, null], [8, null]], {
        form: [0, "form"]
        ...
        ngForOf: [0, "ngForOf"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](32, 0, null, null, 5, "div", [["fxLayout", "column"]], null, null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](33, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultLayoutDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["LayoutStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxLayout: [0, "fxLayout"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](34, 0, null, null, 1, "div", [["fxFlex", "0 0 auto"]], [[4, "height", null]], null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](35, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultFlexDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["LAYOUT_CONFIG"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["FlexStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxFlex: [0, "fxFlex"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵand"](16777216, null, null, 1, null, View_TsCSVEntryComponent_5)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](37, 278528, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["TemplateRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["IterableDiffers"]], {
        ngForOf: [0, "ngForOf"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](38, 0, null, null, 26, "div", [["class", "c-csv-entry__messages"], ["fxLayout", "column"], ["fxLayoutAlign", "start stretch"]], null, null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](39, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultLayoutDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["LayoutStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxLayout: [0, "fxLayout"]
      }, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](40, 1720320, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultLayoutGapDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"], _angular_cdk_bidi__WEBPACK_IMPORTED_MODULE_9__["Directionality"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["LayoutGapStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxLayoutGap: [0, "fxLayoutGap"]
      }, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](41, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultLayoutAlignDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["LayoutAlignStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxLayoutAlign: [0, "fxLayoutAlign"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](42, 0, null, null, 6, "div", [["fxLayout", "column"], ["fxLayoutAlign", "center end"]], null, null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](43, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultLayoutDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["LayoutStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxLayout: [0, "fxLayout"]
      }, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](44, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultLayoutAlignDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["LayoutAlignStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxLayoutAlign: [0, "fxLayoutAlign"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵand"](16777216, null, null, 1, null, View_TsCSVEntryComponent_6)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](46, 278528, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["TemplateRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["IterableDiffers"]], {
        ngForOf: [0, "ngForOf"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵand"](16777216, null, null, 1, null, View_TsCSVEntryComponent_7)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](48, 16384, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["TemplateRef"]], {
        ngIf: [0, "ngIf"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](49, 0, null, null, 15, "div", [["fxLayout", "row"], ["fxLayoutAlign", "space-between center"]], [[8, "dir", 0]], null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](50, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultLayoutDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["LayoutStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxLayout: [0, "fxLayout"]
      }, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](51, 1720320, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultLayoutGapDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"], _angular_cdk_bidi__WEBPACK_IMPORTED_MODULE_9__["Directionality"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["LayoutGapStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxLayoutGap: [0, "fxLayoutGap"]
      }, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](52, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultLayoutAlignDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["LayoutAlignStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxLayoutAlign: [0, "fxLayoutAlign"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](53, 0, null, null, 7, "div", [["dir", "ltr"], ["fxLayoutGap", "1em"]], null, null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](54, 1720320, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["DefaultLayoutGapDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"], _angular_cdk_bidi__WEBPACK_IMPORTED_MODULE_9__["Directionality"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_11__["LayoutGapStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_4__["MediaMarshaller"]], {
        fxLayoutGap: [0, "fxLayoutGap"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](55, 0, null, null, 2, "ts-button", [["class", "qa-csv-entry-reset ts-button"], ["format", "hollow"], ["id", "ts-csv-reset"], ["theme", "warn"]], null, [[null, "clicked"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
        ...
        return ad;
      }, _button_terminus_ui_button_ngfactory__WEBPACK_IMPORTED_MODULE_28__["View_TsButtonComponent_0"], _button_terminus_ui_button_ngfactory__WEBPACK_IMPORTED_MODULE_28__["RenderType_TsButtonComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](56, 245760, null, 0, _terminus_ui_button__WEBPACK_IMPORTED_MODULE_22__["TsButtonComponent"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"], _terminus_ngx_tools_browser__WEBPACK_IMPORTED_MODULE_6__["TsWindowService"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"]], {
        format: [0, "format"],
        id: [1, "id"],
        theme: [2, "theme"]
      }, {
        clicked: "clicked"
      }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](-1, 0, ["Reset Table"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](58, 0, null, null, 2, "ts-button", [["class", "qa-csv-entry-add-row ts-button"], ["format", "hollow"], ["id", "ts-csv-add-row"]], null, [[null, "clicked"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
        ...
        var currVal_7 = "0 0 auto";

        _ck(_v, 11, 0, currVal_7);

        var currVal_8 = _co.rows == null ? null : _co.rows.controls;
        ...
        var currVal_17 = _co.recordsForm;

        _ck(_v, 17, 0, currVal_17);

        var currVal_25 = "headers";

        _ck(_v, 21, 0, currVal_25);

        var currVal_26 = _co.headerCells == null ? null : _co.headerCells.controls;

        _ck(_v, 25, 0, currVal_26);

        var currVal_34 = "records";

        _ck(_v, 27, 0, currVal_34);

        var currVal_35 = _co.rows == null ? null : _co.rows.controls;

        _ck(_v, 31, 0, currVal_35);

        var currVal_36 = "column";

        _ck(_v, 33, 0, currVal_36);

        var currVal_38 = "0 0 auto";

        _ck(_v, 35, 0, currVal_38);

        var currVal_39 = _co.rows == null ? null : _co.rows.controls;
        ...
        var currVal_41 = _co.layoutGap;

        _ck(_v, 40, 0, currVal_41);

        var currVal_42 = "start stretch";

        _ck(_v, 41, 0, currVal_42);

        var currVal_43 = "column";

        _ck(_v, 43, 0, currVal_43);

        var currVal_44 = "center end";

        _ck(_v, 44, 0, currVal_44);

        var currVal_45 = _co.validationMessages;

        _ck(_v, 46, 0, currVal_45);

        var currVal_46 = _co.tooManyRowsMessage;
        ...
        var currVal_49 = _co.layoutGap;

        _ck(_v, 51, 0, currVal_49);

        var currVal_50 = "space-between center";

        _ck(_v, 52, 0, currVal_50);

        var currVal_51 = "1em";

        _ck(_v, 54, 0, currVal_51);

        var currVal_52 = "hollow";
        var currVal_53 = "ts-csv-reset";
        var currVal_54 = "warn";

        _ck(_v, 56, 0, currVal_52, currVal_53, currVal_54);

        var currVal_55 = "hollow";
        var currVal_56 = "ts-csv-add-row";

        _ck(_v, 59, 0, currVal_55, currVal_56);
        ...
        var _co = _v.component;
        var currVal_0 = _co.rows.length;
        var currVal_1 = _co.rows.length === 1 ? "" : "s";

        _ck(_v, 2, 0, currVal_0, currVal_1);

        var currVal_2 = _co.columnCount;
        var currVal_3 = _co.columnCount === 1 ? "" : "s";

        _ck(_v, 4, 0, currVal_2, currVal_3);

        var currVal_6 = _co.fakeRowHeight;

        _ck(_v, 10, 0, currVal_6);

        var currVal_9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassUntouched;

        var currVal_10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassTouched;

        var currVal_11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassPristine;

        var currVal_12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassDirty;

        var currVal_13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassValid;

        var currVal_14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassInvalid;

        var currVal_15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassPending;
        ...
        var currVal_27 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassUntouched;

        var currVal_28 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassTouched;

        var currVal_29 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassPristine;

        var currVal_30 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassDirty;

        var currVal_31 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassValid;

        var currVal_32 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassInvalid;

        var currVal_33 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassPending;

        _ck(_v, 26, 0, currVal_27, currVal_28, currVal_29, currVal_30, currVal_31, currVal_32, currVal_33);

        var currVal_37 = _co.fakeRowHeight;

        _ck(_v, 34, 0, currVal_37);

        var currVal_47 = _co.footerDirection;

        _ck(_v, 49, 0, currVal_47);
      });
    }

    function View_TsCSVEntryComponent_Host_0(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 1, "ts-csv-entry", [["class", "ts-csv-entry"]], [[2, "c-csv-entry--full-width", null], [1, "id", 0]], null, null, View_TsCSVEntryComponent_0, RenderType_TsCSVEntryComponent)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](1, 245760, null, 0, _terminus_ui_csv_entry__WEBPACK_IMPORTED_MODULE_1__["TsCSVEntryComponent"], [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"], _terminus_ngx_tools_browser__WEBPACK_IMPORTED_MODULE_6__["TsDocumentService"]], null, null)], function (_ck, _v) {
        _ck(_v, 1, 0);
      }, function (_ck, _v) {
        var currVal_0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 1).fullWidth;
    ...
    var TsCSVEntryComponentNgFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵccf"]("ts-csv-entry", _terminus_ui_csv_entry__WEBPACK_IMPORTED_MODULE_1__["TsCSVEntryComponent"], View_TsCSVEntryComponent_Host_0, {
  ...
  /***/
  function srcAppComponentsCsvEntryCsvEntryRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CSVEntryRoutingModule", function () {
      return CSVEntryRoutingModule;
    });
    /* harmony import */
    ...
    var _csv_entry_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./csv-entry.component */
    ...
    var CSVEntryRoutingModule = function CSVEntryRoutingModule() {
      _classCallCheck(this, CSVEntryRoutingModule);
    };
    /***/
  ...
  /***/
  function srcAppComponentsCsvEntryCsvEntryComponentNgfactoryJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RenderType_CSVEntryComponent", function () {
      return RenderType_CSVEntryComponent;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "View_CSVEntryComponent_0", function () {
      return View_CSVEntryComponent_0;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "View_CSVEntryComponent_Host_0", function () {
      return View_CSVEntryComponent_Host_0;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "CSVEntryComponentNgFactory", function () {
      return CSVEntryComponentNgFactory;
    });
    /* harmony import */
    ...
    var _dist_libs_ui_csv_entry_terminus_ui_csv_entry_ngfactory__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../../../../../dist/libs/ui/csv-entry/terminus-ui-csv-entry.ngfactory */
    "../../dist/libs/ui/csv-entry/terminus-ui-csv-entry.ngfactory.js");
    /* harmony import */


    var _terminus_ui_csv_entry__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! @terminus/ui-csv-entry */
    "../../dist/libs/ui/csv-entry/fesm2015/terminus-ui-csv-entry.js");
    /* harmony import */
    ...
    var _csv_entry_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./csv-entry.component */
    "./src/app/components/csv-entry/csv-entry.component.ts");
    /* harmony import */
    ...
    var RenderType_CSVEntryComponent = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵcrt"]({
      encapsulation: 2,
      styles: styles_CSVEntryComponent,
      data: {}
    });

    function View_CSVEntryComponent_0(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵqud"](402653184, 1, {
        csvComponent: 0
      }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](1, 0, null, null, 40, "ts-card", [["class", "ts-card"], ["tsVerticalSpacing", ""]], null, null, null, _dist_libs_ui_card_terminus_ui_card_ngfactory__WEBPACK_IMPORTED_MODULE_1__["View_TsCardComponent_0"], _dist_libs_ui_card_terminus_ui_card_ngfactory__WEBPACK_IMPORTED_MODULE_1__["RenderType_TsCardComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](2, 49152, null, 0, _terminus_ui_card__WEBPACK_IMPORTED_MODULE_2__["TsCardComponent"], [], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](3, 16384, null, 0, _terminus_ui_spacing__WEBPACK_IMPORTED_MODULE_3__["TsVerticalSpacingDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"]], {
        tsVerticalSpacing: [0, "tsVerticalSpacing"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](4, 0, null, 0, 2, "h3", [["tsVerticalSpacing", ""]], null, null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](5, 16384, null, 0, _terminus_ui_spacing__WEBPACK_IMPORTED_MODULE_3__["TsVerticalSpacingDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"]], {
        tsVerticalSpacing: [0, "tsVerticalSpacing"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](-1, null, ["CSV Entry"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](7, 0, null, 0, 22, "div", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](-1, null, [" Footer direction: "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](9, 0, null, null, 20, "ul", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](10, 0, null, null, 9, "li", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](11, 0, null, null, 8, "label", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](-1, null, [" ltr "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](13, 0, null, null, 6, "input", [["name", "direction"], ["type", "radio"], ["value", "ltr"]], [[2, "ng-untouched", null], [2, "ng-touched", null], [2, "ng-pristine", null], [2, "ng-dirty", null], [2, "ng-valid", null], [2, "ng-invalid", null], [2, "ng-pending", null]], [[null, "ngModelChange"], [null, "input"], [null, "blur"], [null, "compositionstart"], [null, "compositionend"], [null, "change"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
        ...
        return ad;
      }, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](24, 16384, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["DefaultValueAccessor"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], [2, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["COMPOSITION_BUFFER_MODE"]]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](25, 212992, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["RadioControlValueAccessor"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ɵangular_packages_forms_forms_n"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"]], {
        name: [0, "name"],
        value: [1, "value"]
      }, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵprd"](1024, null, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NG_VALUE_ACCESSOR"], function (p0_0, p1_0) {
        return [p0_0, p1_0];
      }, [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["RadioControlValueAccessor"]]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](27, 671744, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgModel"], [[8, null], [8, null], [8, null], [6, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NG_VALUE_ACCESSOR"]]], {
        name: [0, "name"],
        model: [1, "model"]
      }, {
        update: "ngModelChange"
      }), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵprd"](2048, null, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgControl"], null, [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgModel"]]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](29, 16384, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgControlStatus"], [[4, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgControl"]]], null, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](30, 0, null, 0, 6, "div", [["style", "max-width: 80%;"], ["tsVerticalSpacing", ""]], null, null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](31, 16384, null, 0, _terminus_ui_spacing__WEBPACK_IMPORTED_MODULE_3__["TsVerticalSpacingDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"]], {
        tsVerticalSpacing: [0, "tsVerticalSpacing"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](32, 0, null, null, 4, "ts-csv-entry", [["class", "ts-csv-entry"]], [[2, "c-csv-entry--full-width", null], [1, "id", 0]], [[null, "blobGenerated"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
        ...
        return ad;
      }, _dist_libs_ui_csv_entry_terminus_ui_csv_entry_ngfactory__WEBPACK_IMPORTED_MODULE_5__["View_TsCSVEntryComponent_0"], _dist_libs_ui_csv_entry_terminus_ui_csv_entry_ngfactory__WEBPACK_IMPORTED_MODULE_5__["RenderType_TsCSVEntryComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](33, 245760, [[1, 4]], 0, _terminus_ui_csv_entry__WEBPACK_IMPORTED_MODULE_6__["TsCSVEntryComponent"], [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"], _terminus_ngx_tools_browser__WEBPACK_IMPORTED_MODULE_7__["TsDocumentService"]], {
        columnHeaders: [0, "columnHeaders"],
        columnValidators: [1, "columnValidators"],
        footerDirection: [2, "footerDirection"]
      }, {
        blobGenerated: "blobGenerated"
      }), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵpad"](34, 2), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](35, 0, null, 0, 1, "button", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](-1, null, ["My Custom Content!"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](37, 0, null, 0, 1, "button", [], null, [[null, "click"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
        ...
        return ad;
      }, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](-1, null, ["Custom table reset"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](39, 0, null, 0, 0, "br", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](40, 0, null, 0, 1, "button", [], null, [[null, "click"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
        ...
        return ad;
      }, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](-1, null, ["Generate file & download"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](42, 0, null, null, 9, "ts-card", [["class", "ts-card"], ["tsVerticalSpacing", ""]], null, null, null, _dist_libs_ui_card_terminus_ui_card_ngfactory__WEBPACK_IMPORTED_MODULE_1__["View_TsCardComponent_0"], _dist_libs_ui_card_terminus_ui_card_ngfactory__WEBPACK_IMPORTED_MODULE_1__["RenderType_TsCardComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](43, 49152, null, 0, _terminus_ui_card__WEBPACK_IMPORTED_MODULE_2__["TsCardComponent"], [], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](44, 16384, null, 0, _terminus_ui_spacing__WEBPACK_IMPORTED_MODULE_3__["TsVerticalSpacingDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"]], {
        tsVerticalSpacing: [0, "tsVerticalSpacing"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](45, 0, null, 0, 2, "h3", [["tsVerticalSpacing", ""]], null, null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](46, 16384, null, 0, _terminus_ui_spacing__WEBPACK_IMPORTED_MODULE_3__["TsVerticalSpacingDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"]], {
        tsVerticalSpacing: [0, "tsVerticalSpacing"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](-1, null, ["CSV Full Width Entry"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](48, 0, null, 0, 3, "div", [["fxLayout", "row"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](49, 0, null, null, 2, "ts-csv-entry", [["class", "ts-csv-entry"], ["columnCount", "1"]], [[2, "c-csv-entry--full-width", null], [1, "id", 0]], [[null, "blobGenerated"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
        ...
        columnHeaders: [1, "columnHeaders"],
        columnValidators: [2, "columnValidators"],
        fullWidth: [3, "fullWidth"]
      }, {
        blobGenerated: "blobGenerated"
      }), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵpad"](51, 1)], function (_ck, _v) {
        var _co = _v.component;
        var currVal_0 = "";
        ...
        var currVal_9 = "direction";
        var currVal_10 = "ltr";

        _ck(_v, 15, 0, currVal_9, currVal_10);

        var currVal_11 = "direction";
        var currVal_12 = _co.footerDirection;

        _ck(_v, 17, 0, currVal_11, currVal_12);

        var currVal_20 = "direction";
        var currVal_21 = "rtl";

        _ck(_v, 25, 0, currVal_20, currVal_21);

        var currVal_22 = "direction";
        var currVal_23 = _co.footerDirection;
        ...
        var currVal_27 = _ck(_v, 34, 0, "foo", "bar");

        var currVal_28 = _co.validators;
        var currVal_29 = _co.footerDirection;

        _ck(_v, 33, 0, currVal_27, currVal_28, currVal_29);
        ...
        var currVal_35 = _ck(_v, 51, 0, "Full Width");

        var currVal_36 = _co.validators;
        var currVal_37 = true;

        _ck(_v, 50, 0, currVal_34, currVal_35, currVal_36, currVal_37);
      }, function (_ck, _v) {
        var currVal_2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassUntouched;

        var currVal_3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassTouched;

        var currVal_4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassPristine;

        var currVal_5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassDirty;

        var currVal_6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassValid;

        var currVal_7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassInvalid;

        var currVal_8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 19).ngClassPending;

        _ck(_v, 13, 0, currVal_2, currVal_3, currVal_4, currVal_5, currVal_6, currVal_7, currVal_8);

        var currVal_13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassUntouched;

        var currVal_14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassTouched;

        var currVal_15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassPristine;

        var currVal_16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassDirty;

        var currVal_17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassValid;

        var currVal_18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassInvalid;

        var currVal_19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 29).ngClassPending;

        _ck(_v, 23, 0, currVal_13, currVal_14, currVal_15, currVal_16, currVal_17, currVal_18, currVal_19);

        var currVal_25 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 33).fullWidth;

        var currVal_26 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 33).id;

        _ck(_v, 32, 0, currVal_25, currVal_26);

        var currVal_32 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 50).fullWidth;

        var currVal_33 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 50).id;

        _ck(_v, 49, 0, currVal_32, currVal_33);
      });
    }

    function View_CSVEntryComponent_Host_0(_l) {
  ...
  /***/
  function srcAppComponentsCsvEntryCsvEntryComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CSVEntryComponent", function () {
      return CSVEntryComponent;
    });
    /* harmony import */
    ...
    var CSVEntryComponent = /*#__PURE__*/function () {
      function CSVEntryComponent(validatorsService) {
        _classCallCheck(this, CSVEntryComponent);

        this.validatorsService = validatorsService;
        this.validators = [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required, this.validatorsService.url()];
        this.footerDirection = 'ltr';
      }

      _createClass(CSVEntryComponent, [{
        key: "file",
        value: function file(v) {
  ...
  /***/
  function srcAppComponentsCsvEntryCsvEntryModuleNgfactoryJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CSVEntryModuleNgFactory", function () {
      return CSVEntryModuleNgFactory;
    });
    /* harmony import */
    ...
    var _csv_entry_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./csv-entry.module */
    ...
    var _csv_entry_component_ngfactory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./csv-entry.component.ngfactory */
    "./src/app/components/csv-entry/csv-entry.component.ngfactory.js");
    /* harmony import */
    ...
    var _terminus_ui_validators__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! @terminus/ui-validators */
    "../../dist/libs/ui/validators/fesm2015/terminus-ui-validators.js");
    /* harmony import */
    ...
    var _csv_entry_routing_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./csv-entry-routing.module */
    "./src/app/components/csv-entry/csv-entry-routing.module.ts");
    /* harmony import */
    ...
    var _terminus_ui_button__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
    /*! @terminus/ui-button */
    "../../dist/libs/ui/button/fesm2015/terminus-ui-button.js");
    /* harmony import */


    var _terminus_ui_icon_button__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
    /*! @terminus/ui-icon-button */
    "../../dist/libs/ui/icon-button/fesm2015/terminus-ui-icon-button.js");
    /* harmony import */
    ...
    var _terminus_ui_tooltip__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
    /*! @terminus/ui-tooltip */
    "../../dist/libs/ui/tooltip/fesm2015/terminus-ui-tooltip.js");
    /* harmony import */


    var _terminus_ui_csv_entry__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(
    /*! @terminus/ui-csv-entry */
    "../../dist/libs/ui/csv-entry/fesm2015/terminus-ui-csv-entry.js");
    /* harmony import */


    var _terminus_ui_spacing__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(
    /*! @terminus/ui-spacing */
    "../../dist/libs/ui/spacing/fesm2015/terminus-ui-spacing.js");
    /* harmony import */


    var _csv_entry_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(
    /*! ./csv-entry.component */
    "./src/app/components/csv-entry/csv-entry.component.ts");
    /**
     * @fileoverview This file was generated by the Angular template compiler. Do not edit.
    ...
    var CSVEntryModuleNgFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵcmf"](_csv_entry_module__WEBPACK_IMPORTED_MODULE_1__["CSVEntryModule"], [], function (_l) {
  ...
  /***/
  function srcAppComponentsCsvEntryCsvEntryModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CSVEntryModule", function () {
      return CSVEntryModule;
    });

    var CSVEntryModule = function CSVEntryModule() {
      _classCallCheck(this, CSVEntryModule);
    };
    /***/

  }
}]);
//# sourceMappingURL=csv-entry-csv-entry-module-ngfactory-es5.js.map