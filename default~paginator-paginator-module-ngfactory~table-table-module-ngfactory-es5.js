...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~paginator-paginator-module-ngfactory~table-table-module-ngfactory"], {
  ...
  /***/
  function distLibsUiPaginatorFesm2015TerminusUiPaginatorJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TsPaginatorComponent", function () {
      return TsPaginatorComponent;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "TsPaginatorModule", function () {
      return TsPaginatorModule;
    });
    /* harmony import */
    ...
    var _terminus_ui_menu__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! @terminus/ui-menu */
    "../../dist/libs/ui/menu/fesm2015/terminus-ui-menu.js");
    /* harmony import */


    var _terminus_ui_option__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! @terminus/ui-option */
    "../../dist/libs/ui/option/fesm2015/terminus-ui-option.js");
    /* harmony import */


    var _terminus_ui_selection_list__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var _terminus_ngx_tools_coercion__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    var TsPaginatorComponent = /*#__PURE__*/function () {
      function TsPaginatorComponent(changeDetectorRef) {
        _classCallCheck(this, TsPaginatorComponent);
      ...
      _createClass(TsPaginatorComponent, [{
        key: "ngAfterViewInit",
        ...
        value: function initialize() {
          ...
          this.currentPageLabel = this.createCurrentPageLabel(this.currentPageIndex, this.pagesArray, this.totalRecords); // Change to the current page
          // istanbul ignore else
        ...
        value: function currentPageChanged(page) {
          // Set the current page
          this.currentPageIndex = Object(_terminus_ngx_tools_coercion__WEBPACK_IMPORTED_MODULE_10__["coerceNumberProperty"])(page.value); // Create a new label for the menu

          this.currentPageLabel = this.createCurrentPageLabel(this.currentPageIndex, this.pagesArray, this.totalRecords); // Emit an event
        ...
        key: "changePage",
        value: function changePage(destinationPage, currentPage, pages) {
          var destinationIsValid = destinationPage >= this.firstPageIndex && destinationPage <= pages.length;
          var notAlreadyOnPage = destinationPage !== currentPage; // istanbul ignore else
        ...
        value: function isNextButtonDisabled(page) {
        ...
        key: "shouldShowRecordsMessage",
        value: function shouldShowRecordsMessage(message, max, totalRecords) {
          if (totalRecords > max) {
        ...
        key: "recordsPerPageUpdated",
        value: function recordsPerPageUpdated(selection) {
        ...
        key: "menuIsDisabled",
        value: function menuIsDisabled(pagesCount) {
          var moreThanOne = 2;
        ...
        key: "disableRecordsPerPage",
        value: function disableRecordsPerPage(totalRecords, recordsPerPageChoices) {
          var lowestPerPage = Math.min.apply(Math, recordsPerPageChoices);
        ...
        key: "createCurrentPageLabel",
        value: function createCurrentPageLabel(currentPage, pages, totalRecords) {
          var findPage = function findPage(allPages, index) {
            return pages.find(function (page) {
              return page.value === index;
            });
          };

          var foundPage = findPage(pages, currentPage); // If no found page, try the previous page

          if (!foundPage) {
            foundPage = findPage(pages, currentPage - 1); // istanbul ignore else
          ...
          return "".concat(foundPage.name, " of ").concat(totalRecords);
        }
        /**
        ...
        key: "createDefaultPageLabel",
        value: function createDefaultPageLabel(currentPage, totalRecords) {
          var start = this.isZeroBased ? currentPage * this.recordsPerPage : (currentPage - 1) * this.recordsPerPage;
          var end = start + this.recordsPerPage; // '1 - 10'

          if (this.isSimpleMode && !totalRecords) {
            return "".concat(start + 1, " - ").concat(end);
          } // '1 - 10 of 243'


          return "".concat(start + 1, " - ").concat(end, " of ").concat(totalRecords);
        }
        /**
        ...
        value: function createPagesArray(total, perPage, zeroBased) {
          var paginatorArray = [];
          var recordsRemaining = total;
          var page = zeroBased ? 0 : 1; // If there are no records just return an empty array
          ...
          while (recordsRemaining >= perPage) {
            ...
            var rangeStart = pageNumber * perPage - (perPage - 1);
            var rangeEnd = pageNumber * perPage;
            var pageValue = paginatorArray.length + 1; // Create a page object

            paginatorArray.push({
              name: "".concat(rangeStart, " - ").concat(rangeEnd),
              // The value is zero based
              value: pageValue - (zeroBased ? 1 : 0)
            }); // Update the remaining count

            recordsRemaining -= perPage; // Set up for next loop if enough records exist
          ...
          if (recordsRemaining > 0) {
            ...
            var _pageNumber = page < 1 ? 1 : page;

            var _pageValue = paginatorArray.length + 1;

            if (paginatorArray.length > 0) {
              name = "".concat(_pageNumber * perPage + 1, " - ").concat(_pageNumber * perPage + recordsRemaining);
              value = _pageValue - (zeroBased ? 1 : 0);
            } else {
              name = "".concat(_pageNumber, " - ").concat(recordsRemaining);
              value = _pageValue - (zeroBased ? 1 : 0);
            }
          ...
          return paginatorArray.sort(function (a, b) {
            var first = Object(_terminus_ngx_tools_coercion__WEBPACK_IMPORTED_MODULE_10__["coerceNumberProperty"])(a.value);
            var second = Object(_terminus_ngx_tools_coercion__WEBPACK_IMPORTED_MODULE_10__["coerceNumberProperty"])(b.value);
        ...
        key: "trackPagesArray",
        value: function trackPagesArray(index, page) {
    ...
    TsPaginatorComponent.ctorParameters = function () {
      return [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ChangeDetectorRef"]
      }];
    };

    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], TsPaginatorComponent.prototype, "isZeroBased", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], TsPaginatorComponent.prototype, "firstPageTooltip", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], TsPaginatorComponent.prototype, "previousPageTooltip", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], TsPaginatorComponent.prototype, "nextPageTooltip", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], TsPaginatorComponent.prototype, "lastPageTooltip", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Number), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Number])], TsPaginatorComponent.prototype, "currentPageIndex", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Number)], TsPaginatorComponent.prototype, "maxPreferredRecords", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", String)], TsPaginatorComponent.prototype, "menuLocation", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_2__["TemplateRef"])], TsPaginatorComponent.prototype, "paginatorMessageTemplate", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", String)], TsPaginatorComponent.prototype, "theme", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Number), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Number])], TsPaginatorComponent.prototype, "totalRecords", null);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", String)], TsPaginatorComponent.prototype, "recordCountTooHighMessage", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Array)], TsPaginatorComponent.prototype, "recordsPerPageChoices", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], TsPaginatorComponent.prototype, "recordsSelectLabel", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], TsPaginatorComponent.prototype, "showRecordsPerPageSelector", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], TsPaginatorComponent.prototype, "isSimpleMode", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Boolean)], TsPaginatorComponent.prototype, "isNextDisabled", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], TsPaginatorComponent.prototype, "pageSelect", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], TsPaginatorComponent.prototype, "recordsPerPageChange", void 0);
    TsPaginatorComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_2__["ChangeDetectorRef"]])], TsPaginatorComponent);

    var TsPaginatorModule = function TsPaginatorModule() {
      _classCallCheck(this, TsPaginatorModule);
    };

    TsPaginatorModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _terminus_ui_button__WEBPACK_IMPORTED_MODULE_5__["TsButtonModule"], _terminus_ui_menu__WEBPACK_IMPORTED_MODULE_6__["TsMenuModule"], _terminus_ui_option__WEBPACK_IMPORTED_MODULE_7__["TsOptionModule"], _terminus_ui_selection_list__WEBPACK_IMPORTED_MODULE_8__["TsSelectionListModule"], _terminus_ui_tooltip__WEBPACK_IMPORTED_MODULE_9__["TsTooltipModule"]],
  ...
  /***/
  function distLibsUiPaginatorTerminusUiPaginatorNgfactoryJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TsPaginatorModuleNgFactory", function () {
      return TsPaginatorModuleNgFactory;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "RenderType_TsPaginatorComponent", function () {
      return RenderType_TsPaginatorComponent;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "View_TsPaginatorComponent_0", function () {
      return View_TsPaginatorComponent_0;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "View_TsPaginatorComponent_Host_0", function () {
      return View_TsPaginatorComponent_Host_0;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "TsPaginatorComponentNgFactory", function () {
      return TsPaginatorComponentNgFactory;
    });
    /* harmony import */
    ...
    var _terminus_ui_button__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
    /*! @terminus/ui-button */
    "../../dist/libs/ui/button/fesm2015/terminus-ui-button.js");
    /* harmony import */
    ...
    var _terminus_ui_menu__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(
    /*! @terminus/ui-menu */
    "../../dist/libs/ui/menu/fesm2015/terminus-ui-menu.js");
    /* harmony import */
    ...
    var _terminus_ui_checkbox__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(
    /*! @terminus/ui-checkbox */
    "../../dist/libs/ui/checkbox/fesm2015/terminus-ui-checkbox.js");
    /* harmony import */


    var _terminus_ui_option__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(
    /*! @terminus/ui-option */
    "../../dist/libs/ui/option/fesm2015/terminus-ui-option.js");
    /* harmony import */


    var _terminus_ui_chip__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(
    /*! @terminus/ui-chip */
    "../../dist/libs/ui/chip/fesm2015/terminus-ui-chip.js");
    /* harmony import */


    var _terminus_ui_form_field__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(
    /*! @terminus/ui-form-field */
    "../../dist/libs/ui/form-field/fesm2015/terminus-ui-form-field.js");
    /* harmony import */


    var _terminus_ui_input__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(
    /*! @terminus/ui-input */
    "../../dist/libs/ui/input/fesm2015/terminus-ui-input.js");
    /* harmony import */


    var _terminus_ui_tooltip__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(
    /*! @terminus/ui-tooltip */
    "../../dist/libs/ui/tooltip/fesm2015/terminus-ui-tooltip.js");
    /* harmony import */


    var _option_terminus_ui_option_ngfactory__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(
    /*! ../option/terminus-ui-option.ngfactory */
    "../../dist/libs/ui/option/terminus-ui-option.ngfactory.js");
    /* harmony import */


    var _selection_list_terminus_ui_selection_list_ngfactory__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(
    /*! ../selection-list/terminus-ui-selection-list.ngfactory */
    "../../dist/libs/ui/selection-list/terminus-ui-selection-list.ngfactory.js");
    /* harmony import */


    var _menu_terminus_ui_menu_ngfactory__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(
    /*! ../menu/terminus-ui-menu.ngfactory */
    "../../dist/libs/ui/menu/terminus-ui-menu.ngfactory.js");
    /* harmony import */


    var _tooltip_terminus_ui_tooltip_ngfactory__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(
    /*! ../tooltip/terminus-ui-tooltip.ngfactory */
    "../../dist/libs/ui/tooltip/terminus-ui-tooltip.ngfactory.js");
    /* harmony import */


    var _button_terminus_ui_button_ngfactory__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(
    ...
    var TsPaginatorModuleNgFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵcmf"](_terminus_ui_paginator__WEBPACK_IMPORTED_MODULE_1__["TsPaginatorModule"], [], function (_l) {
    ...
    var RenderType_TsPaginatorComponent = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵcrt"]({
      encapsulation: 2,
      styles: styles_TsPaginatorComponent,
      data: {}
    });

    function View_TsPaginatorComponent_2(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 4, "ts-option", [["class", "ts-option"], ["role", "option"]], [[2, "ts-selected", null], [2, "ts-option--multiple", null], [2, "ts-option--active", null], [2, "ts-option--disabled", null], [2, "ts-option--template", null], [1, "tabindex", 0], [1, "aria-selected", 0], [1, "aria-disabled", 0], [1, "title", 0], [8, "id", 0]], [[null, "click"], [null, "keydown"]], function (_v, en, $event) {
        ...
        return ad;
      }, _option_terminus_ui_option_ngfactory__WEBPACK_IMPORTED_MODULE_42__["View_TsOptionComponent_0"], _option_terminus_ui_option_ngfactory__WEBPACK_IMPORTED_MODULE_42__["RenderType_TsOptionComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](1, 9617408, [[1, 4]], 2, _terminus_ui_option__WEBPACK_IMPORTED_MODULE_37__["TsOptionComponent"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"], [2, _terminus_ui_option__WEBPACK_IMPORTED_MODULE_37__["TS_OPTION_PARENT_COMPONENT"]], [2, _terminus_ui_option__WEBPACK_IMPORTED_MODULE_37__["TS_OPTGROUP_PARENT_COMPONENT"]]], {
        value: [0, "value"]
    ...
    function View_TsPaginatorComponent_1(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 10, "ts-selection-list", [["class", "qa-paginator-per-page-select ts-selection-list"]], [[2, "ng-untouched", null], [2, "ng-touched", null], [2, "ng-pristine", null], [2, "ng-dirty", null], [2, "ng-valid", null], [2, "ng-invalid", null], [2, "ng-pending", null], [2, "ts-selection-list--required", null], [2, "ts-selection-list--disabled", null], [2, "ts-selection-list--single", null], [2, "ts-selection-list--multiple", null], [1, "aria-owns", 0], [1, "aria-required", 0], [1, "aria-multiselectable", 0]], [[null, "selectionChange"]], function (_v, en, $event) {
        ...
        optionGroups: 1
      }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵand"](16777216, null, 0, 1, null, View_TsPaginatorComponent_2)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](10, 278528, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["TemplateRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["IterableDiffers"]], {
        ngForOf: [0, "ngForOf"]
      }, null)], function (_ck, _v) {
        var _co = _v.component;
        var currVal_14 = _co.pageControl;

        _ck(_v, 3, 0, currVal_14);

        var currVal_15 = _co.allowUserInput;

        var currVal_16 = _co.disableRecordsPerPage(_co.totalRecords, _co.recordsPerPageChoices);

        var currVal_17 = true;
        var currVal_18 = _co.recordsSelectLabel;

        _ck(_v, 6, 0, currVal_15, currVal_16, currVal_17, currVal_18);

        var currVal_19 = _co.recordsPerPageChoices;
        ...
        var currVal_7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 6).isRequired;

        var currVal_8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 6).isDisabled;

        var currVal_9 = !_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 6).allowMultiple;

        var currVal_10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 6).allowMultiple;

        var currVal_11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 6).panelOpen ? _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 6).optionIds : null;

        var currVal_12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 6).isRequired.toString();

        var currVal_13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 6).allowMultiple;
    ...
    function View_TsPaginatorComponent_3(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 6, "ts-menu", [["class", "qa-paginator-current-page-menu ts-menu"]], [[2, "ts-menu--disabled", null]], null, null, _menu_terminus_ui_menu_ngfactory__WEBPACK_IMPORTED_MODULE_44__["View_TsMenuComponent_0"], _menu_terminus_ui_menu_ngfactory__WEBPACK_IMPORTED_MODULE_44__["RenderType_TsMenuComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](1, 278528, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgClass"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["IterableDiffers"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["KeyValueDiffers"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"]], {
        ...
        "disabled": 0
      }), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](3, 933888, null, 0, _angular_flex_layout_extended__WEBPACK_IMPORTED_MODULE_23__["DefaultClassDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_7__["StyleUtils"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_7__["MediaMarshaller"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["IterableDiffers"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["KeyValueDiffers"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"], [6, _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgClass"]]], {
        ngClass: [0, "ngClass"],
        klass: [1, "klass"]
      }, null), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵpod"](4, {
        "disabled": 0
      }), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](5, 4308992, null, 0, _terminus_ui_menu__WEBPACK_IMPORTED_MODULE_34__["TsMenuComponent"], [], {
        isDisabled: [0, "isDisabled"],
        menuItemsTemplate: [1, "menuItemsTemplate"],
        menuPositionY: [2, "menuPositionY"],
        theme: [3, "theme"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](6, 0, ["", ""]))], function (_ck, _v) {
        var _co = _v.component;
        var currVal_1 = "qa-paginator-current-page-menu";

        var currVal_2 = _ck(_v, 2, 0, _co.menuIsDisabled(_co.pagesArray == null ? null : _co.pagesArray.length));

        _ck(_v, 1, 0, currVal_1, currVal_2);

        var currVal_3 = _ck(_v, 4, 0, _co.menuIsDisabled(_co.pagesArray == null ? null : _co.pagesArray.length));

        var currVal_4 = "qa-paginator-current-page-menu";

        _ck(_v, 3, 0, currVal_3, currVal_4);

        var currVal_5 = _co.menuIsDisabled(_co.pagesArray == null ? null : _co.pagesArray.length);

        var currVal_6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v.parent, 26);

        var currVal_7 = _co.menuLocation;
        var currVal_8 = _co.theme;

        _ck(_v, 5, 0, currVal_5, currVal_6, currVal_7, currVal_8);
      }, function (_ck, _v) {
        var _co = _v.component;

        var currVal_0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v, 5).isDisabled;

        _ck(_v, 0, 0, currVal_0);

        var currVal_9 = _co.currentPageLabel;

        _ck(_v, 6, 0, currVal_9);
      });
    }

    function View_TsPaginatorComponent_4(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 1, "div", [["class", "c-paginator__current-page"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](1, null, ["", ""]))], null, function (_ck, _v) {
        var _co = _v.component;
        var currVal_0 = _co.currentPageLabel;

        _ck(_v, 1, 0, currVal_0);
      });
    }

    function View_TsPaginatorComponent_5(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 3, "ts-tooltip", [["class", "ts-tooltip"]], null, null, null, _tooltip_terminus_ui_tooltip_ngfactory__WEBPACK_IMPORTED_MODULE_45__["View_TsTooltipComponent_0"], _tooltip_terminus_ui_tooltip_ngfactory__WEBPACK_IMPORTED_MODULE_45__["RenderType_TsTooltipComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](1, 49152, null, 0, _terminus_ui_tooltip__WEBPACK_IMPORTED_MODULE_41__["TsTooltipComponent"], [], {
      ...
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](2, 0, null, 0, 1, "ts-button", [["class", "qa-paginator-last-page-button ts-button"]], null, [[null, "clicked"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
        ...
        var _co = _v.component;
        var currVal_0 = _co.isNextButtonDisabled(_co.currentPageIndex) ? "" : _co.lastPageTooltip;

        _ck(_v, 1, 0, currVal_0);

        var currVal_1 = _co.lastPageIcon;

        var currVal_2 = _co.isNextButtonDisabled(_co.currentPageIndex);
    ...
    function View_TsPaginatorComponent_6(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 2, "div", [["class", "c-paginator__message qa-paginator-message"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](1, 16777216, null, null, 1, null, null, null, null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](2, 540672, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgTemplateOutlet"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewContainerRef"]], {
        ...
        var _co = _v.component;
        var currVal_0 = _co.templateContext;

        var currVal_1 = _co.paginatorMessageTemplate || _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵnov"](_v.parent, 27);

        _ck(_v, 2, 0, currVal_0, currVal_1);
      }, null);
    }

    function View_TsPaginatorComponent_8(_l) {
    ...
    function View_TsPaginatorComponent_7(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵand"](16777216, null, null, 1, null, View_TsPaginatorComponent_8)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](1, 278528, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["TemplateRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["IterableDiffers"]], {
        ...
        var _co = _v.component;
        var currVal_0 = _co.pagesArray;
        var currVal_1 = _co.trackPagesArray;

        _ck(_v, 1, 0, currVal_0, currVal_1);
      }, null);
    }

    function View_TsPaginatorComponent_9(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵted"](0, null, [" ", "\n"]))], null, function (_ck, _v) {
    ...
    function View_TsPaginatorComponent_0(_l) {
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](2, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 25, "div", [["class", "c-paginator qa-paginator"]], [[2, "c-paginator--simple-mode", null]], null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](1, 0, null, null, 22, "div", [["fxLayout", "row"], ["fxLayoutAlign", "start start"]], null, null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](2, 671744, null, 0, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_22__["DefaultLayoutDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_7__["StyleUtils"], _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_22__["LayoutStyleBuilder"], _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_7__["MediaMarshaller"]], {
        ...
        tooltipValue: [0, "tooltipValue"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](12, 0, null, 0, 1, "ts-button", [["class", "qa-paginator-previous-page-button ts-button"]], null, [[null, "clicked"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
        ...
        clicked: "clicked"
      }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵand"](16777216, null, null, 1, null, View_TsPaginatorComponent_3)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](15, 16384, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["TemplateRef"]], {
        ngIf: [0, "ngIf"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵand"](16777216, null, null, 1, null, View_TsPaginatorComponent_4)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](17, 16384, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["TemplateRef"]], {
        ngIf: [0, "ngIf"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](18, 0, null, null, 3, "ts-tooltip", [["class", "ts-tooltip"]], null, null, null, _tooltip_terminus_ui_tooltip_ngfactory__WEBPACK_IMPORTED_MODULE_45__["View_TsTooltipComponent_0"], _tooltip_terminus_ui_tooltip_ngfactory__WEBPACK_IMPORTED_MODULE_45__["RenderType_TsTooltipComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](19, 49152, null, 0, _terminus_ui_tooltip__WEBPACK_IMPORTED_MODULE_41__["TsTooltipComponent"], [], {
        tooltipValue: [0, "tooltipValue"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](20, 0, null, 0, 1, "ts-button", [["class", "qa-paginator-next-page-button ts-button"]], null, [[null, "clicked"]], function (_v, en, $event) {
        var ad = true;
        var _co = _v.component;
        ...
        clicked: "clicked"
      }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵand"](16777216, null, null, 1, null, View_TsPaginatorComponent_5)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](23, 16384, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["TemplateRef"]], {
        ngIf: [0, "ngIf"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵand"](16777216, null, null, 1, null, View_TsPaginatorComponent_6)), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵdid"](25, 16384, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["TemplateRef"]], {
        ngIf: [0, "ngIf"]
      }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵand"](0, [["menuItems", 2]], null, 0, null, View_TsPaginatorComponent_7)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵand"](0, [["defaultPaginatorMessageTemplate", 2]], null, 0, null, View_TsPaginatorComponent_9))], function (_ck, _v) {
        var _co = _v.component;
        var currVal_1 = "row";

        _ck(_v, 2, 0, currVal_1);

        var currVal_2 = "start start";

        _ck(_v, 3, 0, currVal_2);

        var currVal_3 = _co.recordsPerPageChoices && _co.showRecordsPerPageSelector;

        _ck(_v, 5, 0, currVal_3);

        var currVal_4 = _co.isFirstPage(_co.currentPageIndex) ? "" : _co.firstPageTooltip;

        _ck(_v, 7, 0, currVal_4);

        var currVal_5 = _co.firstPageIcon;

        var currVal_6 = _co.isFirstPage(_co.currentPageIndex);

        var currVal_7 = _co.theme;

        _ck(_v, 9, 0, currVal_5, currVal_6, currVal_7);

        var currVal_8 = _co.isFirstPage(_co.currentPageIndex) ? "" : _co.previousPageTooltip;

        _ck(_v, 11, 0, currVal_8);

        var currVal_9 = _co.previousPageIcon;

        var currVal_10 = _co.isFirstPage(_co.currentPageIndex);

        var currVal_11 = _co.theme;

        _ck(_v, 13, 0, currVal_9, currVal_10, currVal_11);

        var currVal_12 = !_co.isSimpleMode;

        _ck(_v, 15, 0, currVal_12);

        var currVal_13 = _co.isSimpleMode;

        _ck(_v, 17, 0, currVal_13);

        var currVal_14 = _co.isNextButtonDisabled(_co.currentPageIndex) ? "" : _co.nextPageTooltip;

        _ck(_v, 19, 0, currVal_14);

        var currVal_15 = _co.nextPageIcon;

        var currVal_16 = _co.isNextButtonDisabled(_co.currentPageIndex);

        var currVal_17 = _co.theme;

        _ck(_v, 21, 0, currVal_15, currVal_16, currVal_17);

        var currVal_18 = !_co.isSimpleMode;

        _ck(_v, 23, 0, currVal_18);

        var currVal_19 = _co.shouldShowRecordsMessage(_co.recordCountTooHighMessage, _co.maxPreferredRecords, _co.totalRecords);

        _ck(_v, 25, 0, currVal_19);
      }, function (_ck, _v) {
        var _co = _v.component;
        var currVal_0 = _co.isSimpleMode;

        _ck(_v, 0, 0, currVal_0);
      });
    }

    function View_TsPaginatorComponent_Host_0(_l) {
...
//# sourceMappingURL=default~paginator-paginator-module-ngfactory~table-table-module-ngfactory-es5.js.map